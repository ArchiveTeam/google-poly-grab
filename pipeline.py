...
LUA_SHA1 = get_hash(os.path.join(CWD, 'google-poly.lua'))
...
project = Project(
    title = 'Google Poly',
    project_html = '''
    <img class="project-logo" alt="logo" src="https://wiki.archiveteam.org/images/8/87/Google_Poly_logo.png" height="50px"/>
    <h2>poly.google.com <span class="links"><a href="https://poly.google.com/">Website</a> &middot; <a href="http://tracker.archiveteam.org/google-poly/">Leaderboard</a></span></h2>
    '''
)
...
pipeline = Pipeline(
    ...
    GetItemFromTracker('http://{}/{}/multi={}/'
        ...
        downloader, VERSION),
    PrepareDirectories(warc_prefix='google-poly'),
    WgetDownload(
        WgetArgs(),
        max_tries=1,
